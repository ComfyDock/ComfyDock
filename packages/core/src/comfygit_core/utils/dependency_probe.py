...
class DependencyProbe:
    ...
    def _normalize_name(self, name: str) -> str:
        ...
        This ensures consistency with conflict_analyzer.normalize_package_name_pep503()
        so that constraints generated by the probe match the format expected by
        ...
        Returns:
            Normalized name (e.g., "foo_bar" -> "foo-bar", "Foo-Bar" -> "foo-bar")
        """
